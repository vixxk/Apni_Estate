  ...
  return (
    <section className="py-16 md:py-28 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative glass-card bg-white/60 p-6 md:p-8 rounded-2xl md:rounded-3xl hover:border-blue-200/50 transition-all duration-500 h-full">
                {/* Icon with Styling */}
                <motion.div
        ...
        >
          <div className="glass-panel rounded-2xl md:rounded-3xl p-8 md:p-12">
            <motion.div
              animate={floatingAnimation}
