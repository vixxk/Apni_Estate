        ...
        {stats && (
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-2.5 mb-4">
            <motion.button
              ...
              className={`bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border-2 rounded-xl p-2.5 sm:p-3 shadow-lg transition-all text-left relative overflow-hidden group ${
                statusFilter === "all"
            ...
            <motion.button
              ...
              className={`bg-gradient-to-br from-yellow-500 to-orange-600 rounded-xl p-2.5 sm:p-3 shadow-lg shadow-orange-500/30 transition-all text-left border-2 relative overflow-hidden group ${
            ...
            <motion.button
              ...
              className={`bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl p-2.5 sm:p-3 shadow-lg shadow-green-500/30 transition-all text-left border-2 relative overflow-hidden group ${
            ...
            <motion.button
              ...
              className={`bg-gradient-to-br from-red-500 to-pink-600 rounded-xl p-2.5 sm:p-3 shadow-lg shadow-red-500/30 transition-all text-left border-2 relative overflow-hidden group ${
