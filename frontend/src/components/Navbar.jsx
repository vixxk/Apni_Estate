    ...
    >
      {isLoggedIn && (
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 rounded-lg bg-gray-50 text-sm text-gray-700"
        >
          <UserCircle className="w-4 h-4" />
          <span>My Profile</span>
        </button>
      ...
      {isLoggedIn && (
        <button
          onClick={handleLogout}
          className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-red-600 hover:bg-red-50 mt-2"
        >
          <LogOut className="w-4 h-4" />
          <span>Sign out</span>
        </button>
