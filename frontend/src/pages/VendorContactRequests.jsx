          ...
          {[
            ...
            return (
              ...
              >
                ...
                <div
                  className={`w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br ${stat.gradient} rounded-lg sm:rounded-xl flex items-center justify-center shadow-md mb-2 relative z-10 ${
                    isActive ? "scale-110" : ""
                  }`}
                >
