...
import { Grid, List, SlidersHorizontal, MapPin, Wrench } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        >
          ...
          <p className="text-sm sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto px-2">
            Discover expert construction, legal, vastu, consulting & loan services
          </p>
          <p className="text-xs sm:text-sm text-gray-500 mt-1 sm:mt-2">
            {filteredProperties.length} services found
          </p>
        </motion.header>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-2 w-full">
                  <select
                    ...
                    className="flex-1 px-2 sm:px-3 py-2 text-xs sm:text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                  >
            ...
            >
              <AnimatePresence>
                {filteredProperties.length > 0 ? (
                  ...
                  >
                    <Wrench className="w-12 h-12 sm:w-16 sm:h-16 text-gray-300 mx-auto mb-3 sm:mb-4" />
